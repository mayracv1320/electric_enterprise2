  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-primary btn-sm">Añadir categoría</a>
      	</div>
      </div>
        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_title" class="form-control" placeholder="Ingrese el nombre de la categoria">
		        	</div>
        		</div>
        		<input type="hidden" name="add_category" value="1">
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-category">Añadir categoría</button>
        		</div>
        	</div>
        ...
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nombre de la categoría</label>
                <input type="text" name="e_cat_title" class="form-control" placeholder="Ingrese el nombre de la marca">
              </div>
            </div>
