  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_brand_modal" class="btn btn-primary btn-sm">Agregar marca</a>
      	</div>
      </div>
        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="brand_title" class="form-control" placeholder="Ingrese el nombre de la marca">
		        	</div>
        		</div>
        		<input type="hidden" name="add_brand" value="1">
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-brand">Agregar marca</button>
        		</div>
        	</div>
        ...
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nombre de la marca</label>
                <input type="text" name="e_brand_title" class="form-control" placeholder="Ingrese el nombre de la marca">
              </div>
            </div>
