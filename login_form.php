...
//in action.php page if user click on "Lista para pagar" button that time we will pass data in a form from action.php page
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<p><br/></p>
							 <!--  <a href="#" style="color:#333; list-style:none;">Contraseña olvidada</a>      -->
