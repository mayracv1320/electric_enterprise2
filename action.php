				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/electric_enterprise/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/electric_enterprise/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/electric_enterprise/cancel.php"/>
