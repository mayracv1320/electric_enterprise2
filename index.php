	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Inicio de sesión</a>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<!-- <a href="#" style="color:white; list-style:none;">Contraseña olvidada</a>     -->
						...
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								...
								<div class="panel-heading">$.500.00
									<button style="float:right;" class="btn btn-danger btn-xs">Añadir al carrito</button>
								</div>
							</div>
						</div> -->
					</div>
