								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Gracias </h1>
											<hr/>
											<p>Hola <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Tu proceso de pago se ha  
											completado con éxito y tu ID de transacción es <b><?php echo $trx_id; ?></b><br/>
											puedes seguir comprando.<br/></p>
